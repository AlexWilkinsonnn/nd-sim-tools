...
CAF::CAF( std::string filename, bool isGas )
{
  ...
  cafMVA->Branch("hadTrue", &hadTrue, "hadTrue/D");
  cafMVA->Branch("ND_TrueHadEdep", &ND_TrueHadEdep, "ND_TrueHadEdep/D");
  cafMVA->Branch("ND_TrueHadOutEdep", &ND_TrueHadOutEdep, "ND_TrueHadOutEdep/D");
  cafMVA->Branch("ND_TrueHadContEdep", &ND_TrueHadContEdep, "ND_TrueHadContEdep/D");
  cafMVA->Branch("ND_TrueHadActEdep", &ND_TrueHadActEdep, "ND_TrueHadActEdep/D");
  cafMVA->Branch("eP_ke",        &eP_ke,         "eP_ke/D");
  cafMVA->Branch("eN_ke",        &eN_ke,         "eN_ke/D");
  cafMVA->Branch("ePip_ke",      &ePip_ke,       "ePip_ke/D");
  cafMVA->Branch("ePim_ke",      &ePim_ke,       "ePim_ke/D");
  cafMVA->Branch("ePi0_ke",      &ePi0_ke,       "ePi0_ke/D");
  cafMVA->Branch("eOther_ke",    &eOther_ke,     "eOther_ke/D");
  cafMVA->Branch("ND_eRecoP",        &ND_eRecoP,         "ND_eRecoP/D");
  cafMVA->Branch("ND_eRecoN",        &ND_eRecoN,         "ND_eRecoN/D");
  cafMVA->Branch("ND_eRecoPip",      &ND_eRecoPip,       "ND_eRecoPip/D");
  cafMVA->Branch("ND_eRecoPim",      &ND_eRecoPim,       "ND_eRecoPim/D");
  cafMVA->Branch("ND_eRecoPi0",      &ND_eRecoPi0,       "ND_eRecoPi0/D");
  cafMVA->Branch("ND_eRecoOther",    &ND_eRecoOther,     "ND_eRecoOther/D");
...
void CAF::setToBS()
{
  ...
  hadTrue = 0.; ND_TrueHadEdep = 0.; ND_TrueHadOutEdep = 0.; ND_TrueHadContEdep = 0.; ND_TrueHadActEdep = 0.;
  eP_ke = 0.; eN_ke = 0.; ePip_ke = 0.; ePim_ke = 0.; ePi0_ke = 0.; eOther_ke = 0.;
  ND_eRecoP = 0.; ND_eRecoN = 0.; ND_eRecoPip = 0.; ND_eRecoPim = 0.; ND_eRecoPi0 = 0.; ND_eRecoOther = 0.;
